import { IonBackButton, IonButtons, IonButton, IonCard, IonCardContent, IonCardHeader, IonCardSubtitle, IonCardTitle, IonContent, IonFooter, IonHeader, IonImg, IonItem, IonModal, IonPage, IonTitle, IonToolbar, useIonViewWillEnter, IonIcon, IonLabel } from '@ionic/react';
...
const Details: React.FC<DetailsPageProps> = ({ match }) => {
    ...
    const fetchData = async () => {
        ...
        setInformation(data);
        console.log('The thing that simon wrote here', data);
    };
